...
df, labeled_df, unstructured_df = load_data("labeled_questions2.csv")
...
final_df.to_csv("unstructured_questions_with_clusters4.csv", index=False)
print("📦 Saved to 'unstructured_questions_with_clusters.csv'")

print("emb_labeled", emb_labeled)
